  ...
  return (
    <div style={{ backgroundColor: "black" }}>
      <div style={{ textAlign: "center", padding: "30px" }}>
        <h1 style={{ color: "lime", display: "inline-block", fontSize: "2.5em" }}>grid</h1>
        <h1 style={{ color: "white", display: "inline-block", fontSize: "2.5em" }}>Lock</h1>
      </div>
      <Card style={{
      ...
      <h3 style={{ color: "#909090", textAlign: "center", paddingTop: "30px", fontSize: "1.5em" }}>Token Type Classification</h3>
      <Card style={{
        backgroundColor: "#202020",
        width: "100%",
        border: "1px solid black",
